...
_WAF_SIGNATURES: Dict[str, Dict] = {
    ...
    "wordfence": {
        ...
        "bypass_strategies": [
            "referrer_spoofing", "xff_internal_cidr",
            "case_sensitivity_bypass", "random_path_suffix",
            "unicode_normalization", "accept_header_rotation",
        ],
    },
    "nginx_waf": {
        "headers": [
        ...
        "status": [403],
        "bypass_strategies": [
            "chunked_encoding", "double_url_encoding",
            "overlong_utf8", "path_parameter_pollution",
            "newline_injection",
        ],
    },
    "wallarm": {
        ...
        "body": [
            r"Wallarm",
            r"The request was blocked",
        ],
        "cookies": ["wallarm"],
        "status": [403],
        "bypass_strategies": [
            "chunked_small_chunks", "json_unicode_escape",
            "encoding_chain", "http2_pseudo_header_order",
            "overlong_utf8",
        ],
    },
    "radware": {
        ...
        "body": [
            r"Radware",
            r"AppWall",
            r"Request blocked by AppWall",
        ],
        "cookies": [],
        "status": [403],
        "bypass_strategies": [
            "chunked_encoding", "unicode_normalization",
            "double_url_encoding", "hpp_duplicate_params",
        ],
    },
    "cloudfront": {
        "headers": [
        ...
        "status": [403, 503],
        "bypass_strategies": [
            "header_injection_variants", "xff_internal_cidr",
            "chunked_encoding", "json_unicode_escape",
            "tls_fingerprint_chrome",
        ],
    },
    "reblaze": {
        "headers": [
        ...
        "status": [403],
        "bypass_strategies": [
            "unicode_normalization", "chunked_encoding",
            "referrer_spoofing", "tls_fingerprint_chrome",
        ],
    },
    "dotdefender": {
        "headers": [
            ("x-dotdefender-denied", r".+"),
        ],
        "body": [
...
_PROBE_PAYLOAD = "?id=1'+OR+1=1--&cmd=cat+/etc/passwd&path=../../../../etc/passwd&<script>alert(1)</script>"
